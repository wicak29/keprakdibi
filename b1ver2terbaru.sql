...
--
ALTER TABLE `URAIAN_APBD`
  MODIFY `ID_URAIAN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
-- AUTO_INCREMENT for table `daerah`
--
ALTER TABLE `daerah`
  MODIFY `ID_DAERAH` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
