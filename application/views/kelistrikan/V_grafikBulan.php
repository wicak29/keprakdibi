    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel" style="min-height:538px;">
          <div class="x_title">
            <h2>Grafik Data Kelistrikan Per Periode</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <div style="margin-bottom:50px;">
              <form id="demo-form" action="<?php echo base_url();?>kelistrikan/filter/viewLihatGrafikBulan" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kategori Pelanggan :</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <p style="padding: 5px;">
                        <input type="checkbox" name="uraian[]" value="1" class="uraian-checkbox"/> Rumah Tangga
                        <br />
                        <input type="checkbox" name="uraian[]" value="2" class="uraian-checkbox"/> Industri
                        <br />
                        <input type="checkbox" name="uraian[]" value="3" class="uraian-checkbox"/> Bisnis
                        <br />
                        <input type="checkbox" name="uraian[]" value="4" class="uraian-checkbox"/> Sosial
                        <br />
                        <input type="checkbox" name="uraian[]" value="5" class="uraian-checkbox"/> Pemerintah
                        <br />
                    </div>
                  </div>
                </div>
...
<script>
      ...
      echartLine.setOption({
        title: {
          text: <?php echo '"GRAFIK KELISTRIKAN BULAN '.$periode.' ('.$nama_aspek.')",'?>
          subtext: ''
        },
        tooltip: {
          trigger: 'axis'
