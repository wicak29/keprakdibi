                ...
                <div class="x_panel" style="min-height:538px;">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li>
                        <a href="<?php echo base_url();?>kelistrikan/C_delete" class=""><i class="fa fa-arrow-left"></i> Kembali</a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <form action="<?php echo base_url();?>kelistrikan/C_delete/filterHapusDataKelistrikan/" method="post" enctype="multipart/form-data" class="form-inline">
                    ...
                    <form action="<?php echo base_url();?>kelistrikan/C_delete/deleteDataKelistrikan/" method="post" enctype="multipart/form-data" class="form-inline">
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody id="tabelApbd">                        
                         <?php foreach ($list_data_kelistrikan as $r) { ?>
                           <tr>
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">HAPUS DATA KELISTRIKAN</h4>
                        </div>
