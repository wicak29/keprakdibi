        ...
        <div class="right_col" role="main" style="margin-left: 0px;">
          ...
          <div id="sukses-tambah" class="alert alert-success alert-dismissible fade in" style="margin-top:70px;">
            ...
            <strong>Berhasil!</strong> Kontak berhasil ditambah ke Kelistrikan.
          </div>    
          <div id="gagal-tambah" class="alert alert-danger alert-dismissible fade in" style="margin-top:70px;">
            <a href="#" class="close" data-dismiss="alert" aria-label="close"><span aria-hidden="true">×</span></a>
            <strong>Gagal!</strong> Kontak gagal ditambah ke Kelistrikan!
          </div>
          <!-- END ALERTS -->
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="min-height:538px;">
                  <div class="x_title">
                    <h2>Daftar Kontak Kelistrikan</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <div class="row">
                            ...
                            <div class="well profile_view">
                              ...
                              <div class="col-xs-12 bottom text-center">
                                ...
                                <div class="col-xs-12 col-sm-2 emphasis">
                                  <a href="<?php echo base_url();?>kelistrikan/deleteKontak/<?php echo $pic['ID_KONTAK']; ?>"
                                    <button class="btn btn-danger btn-xs" data-toggle="tooltip" title="Hapus dari Kelistrikan"> 
