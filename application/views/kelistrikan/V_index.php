                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                       <!--  <li role="presentation" class="active"><a href="#tab-apbdp" role="tab" id="apbdp-tab" data-toggle="tab" aria-expanded="true">APDBP</a>
                        ...
                        <li role="presentation" class="active"><a href="#tab-datakelistrikan" id="provinsi-tab" role="tab" data-toggle="tab" aria-expanded="false">Data Kelistrikan</a>
                        </li>
                      ...
                      <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade in" id="tab-uraian" aria-labelledby="profile-tab">
                          <form action="<?php echo base_url();?>kelistrikan/insertUraian/" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            <h3>Data Uraian Kelistrikan</h3>
                            <br>
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="tab-datakelistrikan" aria-labelledby="home-tab">
