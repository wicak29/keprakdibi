              ...
              <form id="demo-form" action="<?php echo base_url();?>kendaraan/filter/viewLihatGrafikBulan" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                <div class="form-group">
                  ...
                  <select name="upt" class="form-control" required="required">
                      ...
                      <option value="1">UPT SAMSAT DENPASAR</option>
                      <option value="3">UPT SAMSAT BADUNG</option>
                      <option value="5">UPT SAMSAT KLUNGKUNG</option>
                      <option value="7">UPT SAMSAT GIANYAR</option>
                      <option value="9">UPT SAMSAT TABANAN</option>
                      <option value="11">UPT SAMSAT BANGLI</option>
                      <option value="12">UPT SAMSAT KARANGASEM</option>
                      <option value="13">UPT SAMSAT JEMBRANA</option>
                      <option value="14">UPT SAMSAT BULELENG</option>
                    </select>
                  </div>
                </div>
                <div class="form-group">
