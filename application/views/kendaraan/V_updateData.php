            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12" style="margin-right:auto; margin-left:auto;float:none;">
                <div class="x_panel" style="min-height:538px;">
                  ...
                  <div class="x_content">
                    <div class="row">
                      <form action="<?php echo base_url();?>kendaraan/C_update/filterDataKendaraan/" method="post" enctype="multipart/form-data" class="form-inline">
                    ...
                    <form action="<?php echo base_url();?>kendaraan/C_update/updateDataKendaraan/" method="post" enctype="multipart/form-data" class="form-inline">
