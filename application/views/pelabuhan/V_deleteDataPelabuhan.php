            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12" style="margin-right:auto; margin-left:auto;float:none;">
                <div class="x_panel" style="min-height:538px;">
                  ...
                  <div class="x_content">
                    <form action="<?php echo base_url();?>pelabuhan/C_delete/filterHapusDataPelabuhan/" method="post" enctype="multipart/form-data" class="form-inline">
                    ...
                    <form action="<?php echo base_url();?>pelabuhan/C_delete/deleteDataPelabuhan/" method="post" enctype="multipart/form-data" class="form-inline">
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th rowspan="2" style="vertical-align: middle;text-align: center;">Pilih</th>
                          <th rowspan="2" style="vertical-align: middle;text-align: center;">Nama Pelabuhan</th>
