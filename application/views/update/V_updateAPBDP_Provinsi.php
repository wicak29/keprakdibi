            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12" style="margin-right:auto; margin-left:auto;float:none;">
                <div class="x_panel" style="min-height:538px;">
                  <div class="x_title">
                    <h2>Update Data Plafon Anggaran Provinsi Bali</h2>
                  ...
                  <div class="x_content">
                    <form action="<?php echo base_url();?>apbd/update/viewUpdateDataAPBDPProv/" method="post" enctype="multipart/form-data" class="form-inline">
                    ...
                    <?php if($tahun!="Tahun") { ?>
                      ...
                      <h3 align="center">Prov. Bali Tahun <?php echo $tahun?></h3>
                    <?php } ?>
                    <!-- <p class="text-muted font-13 m-b-30">
                      DataTables has most features enabled by default, so all you need to do to use it with your own tables is to call the construction function: <code>$().DataTable();</code>
                    </p> -->
                    <form action="<?php echo base_url();?>apbd/update/updateDataNilaiAPBDPProv/" method="post" enctype="multipart/form-data" class="form-inline">
