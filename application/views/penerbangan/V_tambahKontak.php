            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="min-height:538px;">
                  <div class="x_title">
                    <h2>Tambahkan Kontak ke Penerbangan</h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li>
                        <a href="<?php echo base_url();?>penerbangan/viewLihatKontak" class=""><i class="fa fa-user"></i> Lihat Kontak Penerbangan</a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br>
                    <form action="<?php echo base_url();?>penerbangan/addKontakToPenerbangan" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
